    ...
    <div className="dashboard-shell">
      ...
      <main className="dashboard-main">
        <header className="dashboard-topbar">
          ...
          <div className="topbar-search">⌕ <input placeholder="Tìm kiếm học viên, lớp học..." aria-label="Tìm kiếm" /></div>
          <div className="topbar-actions"><button type="button" aria-label="Thông báo">♧<i></i></button><button className="topbar-avatar profile-trigger" type="button" onClick={() => navigate('/profile')} aria-label="Mở trang cá nhân">{user?.fullName?.slice(0, 1).toUpperCase() ?? 'U'}</button></div>
        </header>
